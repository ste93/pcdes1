...
public class Planet {
    ...
    public Planet(int positionX, int positionY) {
        this.setMass(Math.random() * es1.Constants.MAX_MASS + 120000000);
        this.setSpeedX(BigDecimal.valueOf(0));
        this.setSpeedY(BigDecimal.valueOf(0));
    ...
    public void setMass(double mass) {
        this.mass = mass;
        this.setMassPerGravity(this.mass * es1.Constants.GRAVITY);
    }
    ...
    public synchronized void updateAccelerationX(Double accelerationX) {
        this.accelerationX = this.accelerationX.add(BigDecimal.valueOf(accelerationX));
    }
    ...
    public synchronized void updateAccelerationY(Double accelerationY) {
        this.accelerationY = this.accelerationY.add(BigDecimal.valueOf(accelerationY));
    }
}
